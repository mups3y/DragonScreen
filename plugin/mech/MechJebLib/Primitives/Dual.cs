...
namespace MechJebLib.Primitives
{
    public readonly struct Dual : IEquatable<Dual>, IComparable<Dual>, IFormattable
    {
        ...
        public static Dual Sqrt(Dual d)          => new Dual(Math.Sqrt(d.M), 1.0 / (2 * Math.Sqrt(Math.Max(d.M, 1e-15))) * d.D);
        public static Dual Max(Dual d, double i) => new Dual(Math.Max(d.M, i), d.M > i ? d.D : 0);
