...
public static class TestMain
{
    public static int Main()
    {
        ...
        bad += VideoCamRowsTest.Run();    // S134b / QC VV-02: the Video page's camera rows are touchable // S134a / QC F-04: one strip geometry, two projections   // S133 / QC H-05: Frame 58's ALERT ACTIVITY panel // S132 / H11: Frame 58's FRAME, CAMERA and stopwatch      // S130 / H7: the Figma UI's alarm channel finally has a consumer       // S128: what the Cover's four action rows do, and cannot do       // S154a: Frame 58's element geometry (research only - draws nothing)
