...
/*
 * ---- PORTED VERBATIM into DragonScreen from MechJebLib/FuelFlowSimulation/SimVessel.cs ----
 * Per docs/MECHJEBLIB_PORT.md. The simulated vessel: per-stage part/engine/RCS lists, staging, and
 * the thrust/mass rollups the FuelFlowSimulation steps through.
 */
using System;
