...
/*
 * ---- PORTED VERBATIM into DragonScreen from MechJebLib/Primitives/HBase.cs ----
 * Per docs/MECHJEBLIB_PORT.md. The generic Hermite-interpolant base + its keyframe struct. H1 (the
 * double specialisation the engine curves use) derives from this. Copied as-is; no hand edits.
 */
using System;
