...
namespace DragonScreen
{
    public static class Actuator
    {
        ...
        // ⚠ W2 MARKING (2026-09-04, comment only): this is the same B3 "researched default" class as
        // pure/ThrustBalance.cs's constants — R1 §7.4 records no source for it and R1 §5.1 records that
        // engine-out was NEVER FLOWN. UN-CONVERGED; establish its regime from a recorded flight (§B16.8).
