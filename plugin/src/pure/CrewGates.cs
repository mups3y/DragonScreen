...
//
// ---- RESTORED BY W4 (Wave D, §B12.8), 2026-09-04, from `8b81816^` — 6,094 B, byte-for-byte R1 §5.1's row.
// ⛔ §1.4 SOURCE-OF-TRUTH MATERIAL — R1 §5.1's verdict on this file is *"do NOT edit without a real-source
// confirmation"*, and that is a rule, not advice. Every gate TITLE and every checklist ITEM below is a
// transcribed NASA/SpaceX crew-timeline callout. Do not reword one to make a test pass or a card fit.
// ⚠ ITS SOURCE DB IS NOT IN THE TREE. The header cites `data/crew_missions.json`; that file was deleted
// 2026-09-01 (R1 §5.4) and survives only in git history at `8b81816^`. So the "regen this from the DB"
// instruction cannot be followed from the working tree today — recover the DB first, or re-source.
// ============================================================================================
