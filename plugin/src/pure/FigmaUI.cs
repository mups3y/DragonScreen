    ...
    public static class FigmaUI
    {
                                 ...
                                 int suitCountdown, bool suitPopup, int coverPhase)
        {
            ...
            switch (page)
            {
                ...
                case UiPage.Vehicle:   VehicleOverviewPage.Build(dl, w, h); break;
                ...
                case UiPage.VehicleCrew:       VehicleSubsystemPage.Build(dl, w, h, VehicleSubsystemPage.Sub.Crew); break;
                case UiPage.VehiclePropulsion: VehicleSubsystemPage.Build(dl, w, h, VehicleSubsystemPage.Sub.Propulsion); break;
                case UiPage.VehiclePower:      VehicleSubsystemPage.Build(dl, w, h, VehicleSubsystemPage.Sub.Power); break;
                case UiPage.VehicleAvionics:   VehicleSubsystemPage.Build(dl, w, h, VehicleSubsystemPage.Sub.Avionics); break;
                case UiPage.VehicleGnc:        VehicleSubsystemPage.Build(dl, w, h, VehicleSubsystemPage.Sub.Gnc); break;
                case UiPage.VehicleThermal:    VehicleSubsystemPage.Build(dl, w, h, VehicleSubsystemPage.Sub.Thermal); break;
