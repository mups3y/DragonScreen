...
// ============================================================================================
// ============================================================================================
// ⚠ W2 MARKING (2026-09-04) — COMMENT ONLY, NOTHING CHANGED. This wrapper holds no constants of its
// own; every number it depends on is pure/ThrustBalance.cs's, and R1 §7.4 marks those UNATTRIBUTED.
// R1 §5.1: engine-out was NEVER FLOWN, so this whole path is un-exercised. See ThrustBalance's marking.
// ============================================================================================
