...
/*
 * ---- PORTED VERBATIM into DragonScreen from MechJebLib/FuelFlowSimulation/FuelStats.cs ----
 * Per docs/MECHJEBLIB_PORT.md. THE OUTPUT of the sim: one row per KSP stage - thrust, Isp, start/end
 * mass, dv, RCS dv. This is what wires ReturnBudget to a real staged dv budget (step 5 of the port).
 */
