...
/*
 * ---- PORTED VERBATIM into DragonScreen from MechJebLib/FuelFlowSimulation/PartModules/SimModuleEngines.cs ----
 * Per docs/MECHJEBLIB_PORT.md. The engine model - and the reason the H1 curves and V3 were ported:
 * ISPAtConditions/FlowMultiplierAtConditions evaluate the eight engine curves, and RefreshThrust sums
 * the (possibly canted) thrust-transform vectors. Also defines the SimFlowMode enum used across the sim.
 */
