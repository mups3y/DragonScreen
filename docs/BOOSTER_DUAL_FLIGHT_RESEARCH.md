...
> ⚠ **Named contradiction:** §B16 (owner, 2026-09-03) is the current form of booster recovery — a SEPARATE-VESSEL autopilot distinct from the conductor; the deleted `BoosterControl` implementation stays deleted. Cross-reference today's `docs/BOOSTER_RECOVERY_ARCHITECTURE.md`.
