...
- **[INSTALLED_MODS_RESEARCH.md](INSTALLED_MODS_RESEARCH.md)** [CURRENT] — how the RSS/RO install behaves (no reaction wheels, FAR transonic, RealFuels, RealChute, TestFlight).
