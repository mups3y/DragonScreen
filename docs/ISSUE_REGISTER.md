...
| **F5** | max g **4.53 > 4.5** (crew cap) — **STILL PRESENT flight 155116 (max_accel_g 4.527)**, so M1's "FIXED⚑" did NOT hold. | 232712 + 155116: max g 4.53. S2GLimitG=4.1 but the limiter still overshoots ~0.4 g at light S2 mass. | **OPEN — tune** (lower S2GLimitG or add taper lead at light mass). |
