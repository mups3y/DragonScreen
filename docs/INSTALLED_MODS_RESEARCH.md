...
> ⚠ **Named contradiction:** `docs/reference/INSTALLED_MODS.md` is the register C1.15 requires every simulation search to run against. This file is the older survey behind it, **not a substitute for it**.
